...
$sql = "SELECT TRAIN.ID, TRAIN.PLATENUMBER, TRAIN.ORIGIN, TRAIN.DESTINATION, TRAIN.DEPARTTIME, TRAIN.ARRIVETIME, TRAIN.TYPE, TRAIN.PRICE, TRAIN.QUANTITY, TICKETHISTORY.TQUANTITY FROM TRAIN INNER JOIN TICKETHISTORY ON TICKETHISTORY.TRAINID = TRAIN.ID WHERE TICKETHISTORY.ORDERID = '$orderid'";
